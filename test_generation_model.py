...
sys.argv = ['test_generation_model.py', '--test_set_dir','D:/MSc AV Project/cGAN-Seg-main_2/cGAN-Seg_datasets/TiO2SEM/test', '--gen_ckpt_dir','D:/MSc AV Project/cGAN-Seg-main_2/Tio2-SEM_Attention_focalce0.5_tv1_(0.6,0.4)_lr0.0001/Gen.pth', '--output_dir','Tio2SEMGen1/']
